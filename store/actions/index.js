...
// export { addLabel, setLabels, getLabels} from "./labels";

export { addUserContact, deleteUserContact } from "./userContacts";

export { authStoreToken, authGetToken, authAutoSignIn, authLogout } from "./auth";
